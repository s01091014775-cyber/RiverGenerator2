...
python inference.py --target vel --eval --checkpoint %CKPT% --limit 30
echo.
echo [2/2] Batch inference on training labels...
python inference.py --target vel --input_dir datasets\train_label --output_dir results\vel --checkpoint %CKPT% --limit 20
echo.
